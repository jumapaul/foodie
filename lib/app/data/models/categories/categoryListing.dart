import 'dart:convert';
CategoryListing categoryListingFromJson(String str) => CategoryListing.fromJson(json.decode(str));
String categoryListingToJson(CategoryListing data) => json.encode(data.toJson());
class CategoryListing {
  ...
  CategoryListing.fromJson(dynamic json) {
    if (json['meals'] != null) {
      _meals = [];
